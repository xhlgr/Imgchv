$( function () {
    $(document).ready(function(){
    	$(".showoimg").on('click',function(){
    	    ...
    	    $tmptxt3='<img style="width:98%;position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);-moz-transform:translate(-50%,-50%);" src="'+$(this).attr("data-src")+'"/>';
    	    $tmptxt4='<button type="button" class="mw-ui-button mw-ui-progressive" id="showoimgclose" style="position:fixed;top:0;right:0;box-shadow: 1px 1px 3px black;">x</button></div>';
